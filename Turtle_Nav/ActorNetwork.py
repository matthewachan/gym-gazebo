...
from keras.layers import Dense, Flatten, Input, merge, Lambda, Activation, Lambda
...
class ActorNetwork(object):
    ...
    def create_actor_network(self, state_size,action_dim):
        ...
        LinearV = Dense(1, activation='sigmoid', kernel_initializer=uniform(minval=-3e-3,maxval=3e-3,seed=None))(h1)
        AngleV = Dense(1, activation='tanh', kernel_initializer=uniform(minval=-3e-3,maxval=3e-3,seed=None))(h1)
